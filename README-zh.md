...
**[English](README.md)** ｜ **[Technical Report (EN)](docs/Sortify-Technical-Report-en.pdf)** ｜ **[技术报告 (中文)](docs/Sortify-Technical-Report-zh.pdf)** ｜ **[知乎博文](blog/zhihu_post.md)** ｜ **[演示视频](docs/sortify-demo.mp4)**

---

Sortify 是一个 **LLM 驱动的自主智能体**，持续优化推荐系统的排序参数。它将传统的"手动调参 → 上线 → 人工评估"循环替换为全自动闭环——每 4 小时执行一轮，从自身的线上结果中学习并自我修正，无需人工干预。
...
| [知乎博文](blog/zhihu_post.md) | 面向大众的群论视角介绍 |
...
│       └── zh/                            # 中文 (8 篇 + 索引)
├── figures/                               # 架构图与评测图表
│   ├── abs-overview.png                   # 系统概览
│   ├── intro-paradigm.png                 # 传统 vs Sortify 范式对比
│   ├── arch-overview.png                  # 三层架构
│   ├── arch-influence-share.png           # 影响力份额计算流程
│   ├── arch-dual-channel.png              # 双通道正交机制
│   ├── arch-llm-controller.png            # LLM 元控制器数据流
│   ├── arch-data-flow.png                 # 单个 YOLO 周期流程
│   ├── train-01.png                       # YOLO 三态状态机
│   ├── eval-01.png                        # GMV/订单提升轨迹
│   ├── eval-02.png                        # 离线-线上校准散点图
│   ├── eval-03.png                        # 参数演化热力图
│   └── eval-04.png                        # LLM 修正收敛趋势
└── blog/
    └── zhihu_post.md                      # 知乎博文
```
