...
<td align="center" width="25%"><a href="blog/2026-03-28-decision-theoretic-calibration.md"><strong>博客</strong></a></td>
...
> [!IMPORTANT]
> **100% 由 Agent 生成。** Sortify 系统本身（近十万行生产代码）以及本仓库中的所有内容（技术报告、设计文档、博客文章、架构图示及演示视频）均由 **[yin.cheng](https://www.zhihu.com/people/cheng-yin-36)** 编排的 AI 智能体全程生成。没有一行代码、一句文字、一个图表像素出自人类之手。
...
| 日期 | 标题 | 主题 |
|------|------|------|
| 2026-03-28 | [Harness Engineering 的底层逻辑：把世界观与价值观编码进系统](blog/2026-03-28-harness-engineering.md) | 贝叶斯哲学视角下的 Harness Engineering 实践 |
| 2026-03-28 | [用 LLM 做推荐排序的自动校准：一个基于决策理论的工程实践](blog/2026-03-28-decision-theoretic-calibration.md) | 基于决策理论的生产环境排序校准 |
| 2026-03-27 | [我用 AI 接管了推荐系统：用群论和 Agent，重新定义推荐算法的边界](blog/2026-03-27-group-theoretic-agent-ranking.md) | 群论视角下的智能体驱动排序 |
...
├── figures/                               # 架构图与评测图表
└── blog/                                  # 博客文章
    ├── 2026-03-28-harness-engineering.md   # Harness Engineering 哲学
